...
export const CATEGORIES = [
  ...
  {id: 'IssueResolvedCategory', name: i18n('Resolved/reopened issues')},
  {id: 'IssueDeletedCategory', name: i18n('Deleted issues')},
  {id: 'IssueRestoredCategory', name: i18n('Restored issues')},
